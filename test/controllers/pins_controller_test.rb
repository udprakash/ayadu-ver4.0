...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { daily: @pin.daily, description: @pin.description, monthly: @pin.monthly, title: @pin.title, weekly: @pin.weekly }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { daily: @pin.daily, description: @pin.description, monthly: @pin.monthly, title: @pin.title, weekly: @pin.weekly }
    assert_redirected_to pin_path(assigns(:pin))
  end
